...
export const publications: Publication[] = [
  {
    ...
    description: 'Presented research on applying machine learning algorithms for early detection and prediction of skin diseases, contributing to healthcare informatics and dermatological diagnostics.',
    doi: 'Under Review',
    type: 'conference',
    topics: ['Machine Learning', 'Healthcare', 'Skin Disease', 'Predictive Analytics', 'Medical Informatics', 'Dermatology']
  },
  {
    ...
    doi: '10.1109/ICDCC62744.2024.1096096',
    type: 'conference',
